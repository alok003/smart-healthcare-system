...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiExceptionResponseTemplate> handlePatientNotFound(PatientNotFoundException ex) {
        log.warn("action=EXCEPTION_HANDLED exception=PatientNotFoundException reason={}", ex.getMessage());
